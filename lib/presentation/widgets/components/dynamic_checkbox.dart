    ...
    return BlocListener<DynamicFormBloc, DynamicFormState>(
      listener: (context, formState) {
        ...
        if (formState.page?.components != null) {
          ...
          if (updatedComponent.config?.currentState != null &&
              updatedComponent.config?.currentState !=
                  widget.component.config?.currentState) {
            debugPrint(
              '🔄 [Checkbox] External state change detected: ${updatedComponent.config?.currentState}',
            );
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: state.component!.style.labelColor ?? Colors.white,
            ...
            if (hint != null)
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: state.component!.style.hintColor ?? Colors.grey,
            ...
            children: [
              ...
              if (state.leadingIconData != null) ...[
                Icon(
                  ...
                  size: 20,
                  color: state.component!.style.iconColor ?? Colors.blue,
                ),
