      ...
      builder: (context, state) {
        ...
        if (component.states != null) {
          ...
          switch (current_state) {
            case 'error':
              stateStyle = component.states!.error;
              break;
            case 'success':
              stateStyle = component.states!.success;
              break;
            case 'focused':
              stateStyle = component.states!.focused;
              break;
            default:
              stateStyle = component.states!.base;
          }

          if (stateStyle != null) {
            final stateStyleMap = stateStyle.toJson();
            debugPrint(
              '🎨 [${component.id}] Applying $current_state state: $stateStyleMap',
            );
            style.addAll(stateStyleMap);
          }
        }
