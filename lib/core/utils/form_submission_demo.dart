...
class FormSubmissionDemo {
  ...
  static void testFormSubmission() {
    ...
    final componentValues = ComponentValuesModel(
      values: {
    ...
    final formModel = DynamicMultiPageFormModel(
        ...
        FormForMultiPageModel(
          ...
          components: [
            FormComponentMultiPageModel(
              ...
              order: 1,
              config: const ConfigModel(label: 'Full Name', isRequired: true),
            ...
            FormComponentMultiPageModel(
              ...
              order: 3,
              config: const ConfigModel(label: 'Subscribe to Newsletter'),
              style: const StyleModel(),
            ),
          ],
        ),
